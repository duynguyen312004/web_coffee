if (document.body.getAttribute('data-page') === 'coffee') {
    ...
    function renderProducts(products) {
        const container = document.querySelector('.coffee__container .row'); // Thay đổi lớp để phù hợp với HTML của bạn
        if (container) {
                        ...
                        <div class="coffee-item__content">
                            <div class="coffee-item__content-left">
                                ...
                                <p class="coffee-item__price-wrap">
                                    ${formatPrice(product.price)} đ | <span class="coffee-item__status">Còn lại: ${product.inventory}</span> | <span class="tea-item__category">${product.category}</span>
                                </p>
                            </div>
                            <div class="coffee-item__content-right">
                                ...
                                <div class="coffee-item__ctrl">
                                    ...
                                    <button class="coffee-item__edit-btn" onclick="showEditModal(${product.id}, '${product.name}', ${product.price}, ${product.inventory}, '${product.category}', '${product.description}')">
